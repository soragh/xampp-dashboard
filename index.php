...
<div class="topnav">
    ...
    <div class="right"><a href="phpmyadmin">phpMyAdmin</a></div>
    <div><a href="javascript:()" onclick="window.location.href=window.location.href.substring(0, window.location.href.lastIndexOf('/'))+'?phpInfo'">phpInfo</a></div>
